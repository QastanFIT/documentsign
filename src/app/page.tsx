  ...
  return (
    ...
    <div className="grid lg:grid-cols-2 h-[90vh] bg-slate-50">
      ...
      <div className="flex justify-center">
        <div className="w-5/6 mt-16 lg:mt-32">
          <h1 className={`${josefin.className} lg:max-w-[500px] text-3xl lg:text-6xl text-neutral-400 leading-tight font-semibold`}>Onderteken je documenten met <span className="text-neutral-800">DigitalSign</span><br></br> van Qastan.<br></br></h1><p className={`${josefin.className} lg:max-w-[500px] text-3xl lg:text-6xl text-neutral-400 leading-tight font-semibold`}>Snel, eenvoudig en overal!</p>

          <ContactHeader />

          <p className="mt-10 leading-relaxed text-neutral-600">Onderteken je documenten waar je maar wil en wanneer je maar wil, dankzij <strong className="font-normal">DigitalSign</strong> van Qastan. Verspil geen <strong className="italic">kostbare tijd</strong> door te wachten op de papierstroom, maar verstuur en ontvang de <strong className="italic">digitale handtekening</strong> binnen de vijf minuten. Maak als gebruiker zelf de keuze uit verschillende, eenvoudige verificatiemethodes.</p>
        </div>

      </div>

      <div className="hidden sm:inline-block bg-orange-600 overflow-hidden mt-16 lg:mt-0">
        <Image src={bg} alt="Vrouw die digitale handtekening zet in een park" className="object-cover h-full w-full" title="Vrouw die digitale handtekening zet"/>
      </div>
    </div>
    ...
    <div className="pt-20 pb-32 mx-4" id="digitaliseren">
      <div className="max-w-7xl w-full mx-auto flex flex-col items-center">
        ...
        <p>De <span className="font-bold">kracht</span> van <Link href="https://qastan.be/nl/oplossingen/#digitaliseren" className="underline text-orange-600">FITdoc</Link> ligt in het feit dat het in staat is om een naadloze <span className="font-bold">verbinding</span> te leggen tussen <strong>documenten</strong> en <strong>acties</strong>. Stel je voor dat wanneer een document van het juiste type wordt toegevoegd, het systeem automatisch een DigitalSign-proces activeert. Dit betekent dat als gebruiker je enkel nog hoeft te controleren welke documenten al zijn ondertekend en welke nog niet. Dit <strong>bespaart</strong> niet alleen <strong>tijd</strong>, maar minimaliseert ook <strong>menselijke fouten</strong> en versnelt de doorlooptijd van belangrijke processen.</p>
        ...
        <p>Met onze <span className="font-bold">geautomatiseerde oplossing</span> hoef je je <strong>geen zorgen</strong> te maken over handmatige controles of het bijhouden van de status van documenten. <Link href="https://qastan.be/nl/oplossingen/#digitaliseren" className="underline text-orange-600">FITdoc</Link> neemt deze taken op zich, waardoor jij je kunt concentreren op het inhoudelijke werk en de kernaspecten van jouw taken. Dit brengt niet alleen gemak met zich mee, maar optimaliseert ook de workflow, waardoor jouw team zich kan <span className="font-bold">focussen</span> op wat er echt toe doet.</p>
        </div>
      </div>
    </div>
